...
/*PROTECTED REGION ID(usingDSMPracticaGenNHibernate.CEN.DSMPractica_Usuario_contactar) ENABLED START*/
...
public void Contactar (int p_oid)
{
        ...
        throw new NotImplementedException ("Method Contactar() not yet implemented.");
